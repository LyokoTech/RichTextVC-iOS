...
public class RichTextViewController: UIViewController {
    ...
    ///
    /// - returns: True if selection contains at least 1 numbered list, false otherwise
    public func selectionContainsNumberedList(_ range: NSRange) -> Bool {
    ...
    public func selectionContainsBold(_ range: NSRange) -> Bool {
    ...
    public func selectionContainsItalic(_ range: NSRange) -> Bool {
    ...
    public func selectionContainsBulletedList(_ selection: NSRange) -> Bool {
